...
4.  [Parameters](../../docs/dashboards/parameters.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/dashboards/parameters.qmd"
...
variations of a dashboard. For example:
...
Adding parameter definitions to a dashboard works differently depending
...
To parameterize a dashboard, designate a cell with the tag `parameters`
...
When the dashboard is executed with a set of new parameters a cell is
...
To render using different parameters you can pass them on the command
