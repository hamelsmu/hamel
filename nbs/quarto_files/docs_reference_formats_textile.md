...
4.  [Textile](../../../docs/reference/formats/textile.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/textile.qmd"
...
Textile is a simple text markup language that makes it easy to structure
content for blogs, wikis, and documentation. To learn more about Textile
see <https://www.promptworks.com/textile>.
...
<a href="../../../docs/reference/formats/opml.html"
class="pagination-link aria-label=" data-opml"=""><em></em> <span
class="nav-page-text">OPML</span></a>

<a href="../../../docs/reference/formats/docbook.html"
class="pagination-link" aria-label="DocBook"><span
class="nav-page-text">DocBook</span> <em></em></a>
