...
3.  [OpenOffice](../../../docs/reference/formats/odt.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/odt.qmd"
...
OpenDocument, is an open standard file format for word processing
documents It was developed with the aim of providing an open, XML-based
file format specification for office applications. To learn more about
OpenDocument see <https://en.wikipedia.org/wiki/OpenDocument>.
...
<a href="../../../docs/reference/formats/docx.html"
class="pagination-link aria-label=" data-ms="" data-word"=""><em></em>
<span class="nav-page-text">MS Word</span></a>

<a href="../../../docs/reference/formats/epub.html"
class="pagination-link" aria-label="ePub"><span
class="nav-page-text">ePub</span> <em></em></a>
