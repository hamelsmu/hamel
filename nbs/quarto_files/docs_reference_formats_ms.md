...
4.  [Groff Manuscript](../../../docs/reference/formats/ms.html)
    ...
    -   <span class="sidebar-item-text sidebar-link text-start"
        ...
        -   <span class="sidebar-item-text sidebar-link text-start"
            ...
            -   <a href="../../../docs/reference/formats/ms.html"
                ...
                class="menu-text">Groff Manuscript</span></a>
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/ms.qmd"
...
The Groff (GNU troff) manuscript format consists of plain text mixed
with formatting commands that produces PostScript, PDF, or HTML. Learn
more about Groff at <https://www.gnu.org/software/groff/groff.html>.
...
<td style="text-align: left;"><p>The point size, for example,
<code>10p</code>.</p></td>
</tr>
<tr class="odd odd">
<td style="text-align: left;"><code>lineheight</code></td>
<td style="text-align: left;"><p>The line height, for example,
<code>12p</code>.</p></td>
</tr>
</tbody>
</table>
...
<a href="../../../docs/reference/formats/man.html"
class="pagination-link aria-label=" data-groff="" data-man=""
data-page"=""><em></em> <span class="nav-page-text">Groff Man
Page</span></a>

<a href="../../../docs/reference/formats/haddock.html"
class="pagination-link" aria-label="Haddock markup"><span
class="nav-page-text">Haddock markup</span> <em></em></a>
