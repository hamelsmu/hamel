...
4.  [Notebook Editor](../../docs/tools/vscode-notebook.html)
    ...
    -   <span class="sidebar-item-text sidebar-link text-start"
        ...
        -   <a href="../../docs/tools/vscode.html"
            ...
            -   <a href="../../docs/tools/vscode-notebook.html"
                ...
                class="menu-text">Notebook Editor</span></a>
...
-   <a href="#render-and-preview" id="toc-render-and-preview"
    class="nav-link active" data-scroll-target="#render-and-preview">Render
    and Preview</a>
-   <a href="#yaml-front-matter" id="toc-yaml-front-matter" class="nav-link"
    data-scroll-target="#yaml-front-matter">YAML Front Matter</a>
-   <a href="#markdown-cells" id="toc-markdown-cells" class="nav-link"
    data-scroll-target="#markdown-cells">Markdown Cells</a>
-   <a href="#output-options" id="toc-output-options" class="nav-link"
    data-scroll-target="#output-options">Output Options</a>
-   <a href="#cell-execution" id="toc-cell-execution" class="nav-link"
    data-scroll-target="#cell-execution">Cell Execution</a>
-   <a href="#converting-notebooks" id="toc-converting-notebooks"
    class="nav-link" data-scroll-target="#converting-notebooks">Converting
    Notebooks</a>

-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/tools/vscode-notebook.qmd"
...
In addition to editing Quarto documents as plain-text `.qmd` files, you
can also use the VS Code Notebook Editor to author `.ipynb` notebooks
that are rendered with Quarto. In this article we’ll review the basics
of editing `.ipynb` notebooks for use with Quarto.

## Render and Preview

The basic workflow for editing notebooks for use with Quarto is
identical to the workfow for `.qmd` files. Edit the file and then
execute the **Quarto: Preview** command (you can alternatively use the
<span class="kbd">Ctrl+Shift+K</span> keyboard shortcut). You’ll see a
preview of the published page side by side with the notebook:

<img src="images/vscode-notebook.png" class="border img-fluid" />

After you’ve done an initial **Quarto: Preview**, the preview will
automatically update every time you save the notebook.
...
Note that you can switch the type of a cell to **Raw** using the cell
type menu at the bottom right of the cell:

<img src="images/vscode-raw.png" class="border img-fluid"
alt="The top section of an ipynb file open in VSCode. There is a Raw cell containing yaml front matter." />
...
[Authoring](../../docs/authoring/markdown-basics.html) and [Output
Formats](../../docs/output-formats/html-basics.html) for additional
details.
...
<img src="images/vscode-markdown.png" class="border img-fluid"
alt="A snippet of an ipynb document containing a Markdown cell. The cell contains some text written in Markdown." />
...
<img src="images/vscode-cell-options.png" class="border img-fluid"
alt="A snippet of a JupyterLab document containing a code cell. At the top of cell, before the code, are the Quarto chunk options &#39;#| label: fig-polar&#39; and &#39;#| fig-cap: A line plot on a polar axis.&#39;" />
...
hide code, warnings, and/or output. See the documentation on [Output
Options](../../docs/computations/execution-options.html#output-options)
...
using the `quarto convert` command. For example:
...
See `quarto convert help` for additional details on converting
notebooks.
...
<a href="../../docs/tools/neovim.html" class="pagination-link"
aria-label="Neovim"><span class="nav-page-text">Neovim</span>
<em></em></a>
