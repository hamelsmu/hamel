...
4.  [InDesign](../../../docs/reference/formats/icml.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/icml.qmd"
...
ICML is an XML representation of an Adobe InDesign document. You can
learn more about ICML at
...
<a href="../../../docs/reference/formats/docbook.html"
class="pagination-link aria-label=" data-docbook"=""><em></em> <span
class="nav-page-text">DocBook</span></a>

<a href="../../../docs/reference/formats/tei.html"
class="pagination-link" aria-label="TEI Simple"><span
class="nav-page-text">TEI Simple</span> <em></em></a>
