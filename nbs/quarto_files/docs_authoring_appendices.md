...
4.  [Appendices](../../docs/authoring/appendices.html)
...
-   <a href="#custom-appendix-sections" id="toc-custom-appendix-sections"
    class="nav-link" data-scroll-target="#custom-appendix-sections">Custom
    Appendix Sections</a>
-   <a href="#license" id="toc-license" class="nav-link"
    data-scroll-target="#license">License</a>
-   <a href="#appendix-style" id="toc-appendix-style" class="nav-link"
    data-scroll-target="#appendix-style">Appendix Style</a>

-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/authoring/appendices.qmd"
...
HTML pages rendered with Quarto include a formatted appendix at the end
of the article. The appendix includes sections for citations and
footnotes in the document, as well the attribution information (if
specified) for the document itself.

A simple example document appendix looks like:

<img src="images/document-appendix-simple.png" class="border img-fluid"
alt="Appendix with two sections: References, and Footnotes." />

To learn more about including document attribution information in the
appendix, see [Creating Citeable
Articles](../../docs/authoring/create-citeable-articles.html).

## Custom Appendix Sections

Sections of your document can be added to the Appendix that appears at
the end of your article by adding the `.appendix` class to any header.
For example:
...
Any sections marked with the `.appendix` class will be included at the
front of the appendix in the order in which they appear in the document.
A more complete example appendix including attribution and the above
custom appendix section looks like:

<img src="images/document-appendix-full.png" class="border img-fluid"
alt="Appendix with Acknowledgements, References, Footnes, and Citation sections. The Citation section contains both BibTex citation, and plain text for attribution." />

## License

If you include a license in the front matter or citation information for
your document, a ‘Reuse’ section will automatically be added to the
appendix. Read more about specifying a license in [Front
Matter](../../docs/authoring/front-matter.html#license).

Here is an example of a complete appendix including all the fields with
an Attribution-ShareAlike Creative Commons license.

<img src="images/document-appendix-reuse.png" class="border img-fluid"
alt="Appendix with Acknowledgements, References, Footnotes, Reuse, and Citation sections. The Reuse section contains a link to the Attribution-ShareAlike Creative Commons license." />

## Appendix Style

You can control how Quarto process the appendix of your document using
the `appendix-style` option. There are three options available:

`default`  
The default appendix treatment create a smaller font face and gathers
the various sections into stylized groups at the end of the document.

`plain`  
The plain treatment will do all the appendix processing (gathering and
organizing the sections at the end of the document, creating sections
like ‘Reuse’), but will not apply the default appendix styling.

`none`  
`none` disables appendix processing altogether. Content will not be
processed or organized and information like ‘Citation’ and ‘Reuse’ will
not be included in the document.

<a href="../../docs/authoring/create-citeable-articles.html"
class="pagination-link aria-label=" data-creating="" data-citeable=""
data-articles"=""><em></em> <span class="nav-page-text">Creating
Citeable Articles</span></a>

<a href="../../docs/computations/python.html" class="pagination-link"
aria-label="Using Python"><span class="nav-page-text">Using
Python</span> <em></em></a>
