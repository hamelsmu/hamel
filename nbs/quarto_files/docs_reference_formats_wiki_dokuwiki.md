...
4.  [DokuWiki](../../../../docs/reference/formats/wiki/dokuwiki.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/wiki/dokuwiki.qmd"
...
software that doesn’t require a database. To learn more about DokuWiki
...
<a href="../../../../docs/reference/formats/wiki/mediawiki.html"
class="pagination-link aria-label=" data-mediawiki"=""><em></em> <span
class="nav-page-text">MediaWiki</span></a>

<a href="../../../../docs/reference/formats/wiki/zimwiki.html"
class="pagination-link" aria-label="ZimWiki"><span
class="nav-page-text">ZimWiki</span> <em></em></a>
