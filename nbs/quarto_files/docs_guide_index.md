...
Comprehensive guide to using Quarto. If you are just starting out, you
may want to explore the [tutorials](../../docs/get-started/index.html)
to learn the basics.
...
-   [Citations &
    Footnotes](../../docs/authoring/footnotes-and-citations.html)
-   [Cross References](../../docs/authoring/cross-references.html)
-   [Article Layout](../../docs/authoring/article-layout.html)

#### Computations

###### Execute code and display its output

-   [Using Python](../../docs/computations/python.html)
-   [Using R](../../docs/computations/r.html)
-   [Using Julia](../../docs/computations/julia.html)
-   [Using Observable](../../docs/computations/ojs.html)
-   [Execution Options](../../docs/computations/execution-options.html)
-   [Parameters](../../docs/computations/parameters.html)

#### Tools

###### Use your favorite tools with Quarto

-   [JupyterLab](../../docs/tools/jupyter-lab.html)
-   [RStudio IDE](../../docs/tools/rstudio.html)
-   [VS Code](../../docs/tools/vscode.html)
-   [Neovim](../../docs/tools/neovim.html)
-   [Text Editors](../../docs/tools/text-editors.html)
-   [Visual Editor](../../docs/visual-editor/index.html)

#### Documents

###### Generate output in many formats

-   [HTML](../../docs/output-formats/html-basics.html)
-   [PDF](../../docs/output-formats/pdf-basics.html)
-   [MS Word](../../docs/output-formats/ms-word.html)
-   [Markdown](../../docs/output-formats/gfm.html)
-   [All Formats](../../docs/output-formats/all-formats.html)

#### Presentations

###### Present code and technical content

-   [Presentation Basics](../../docs/presentations/index.html)
-   [Revealjs (HTML)](../../docs/presentations/revealjs/index.html)
-   [PowerPoint (Office)](../../docs/presentations/powerpoint.html)
-   [Beamer (PDF)](../../docs/presentations/beamer.html)

#### Dashboards

###### Publish data with dashboards

-   [Dashboard Basics](../../docs/dashboards/index.html)
-   [Components](../../docs/dashboards/components.html)
-   [Data Presentation](../../docs/dashboards/data-presentation.html)
-   [Shiny for
...
-   [Creating a Website](../../docs/websites/index.html)
-   [Website Navigation](../../docs/websites/website-navigation.html)
-   [Creating a Blog](../../docs/websites/website-blog.html)
-   [Website Search](../../docs/websites/website-search.html)
-   [Website Listings](../../docs/websites/website-listings.html)

#### Books

###### Create books and manuscripts

-   [Creating a Book](../../docs/books/index.html)
-   [Book Structure](../../docs/books/book-structure.html)
-   [Book Crossrefs](../../docs/books/book-crossrefs.html)
-   [Customizing Output](../../docs/books/book-output.html)

#### Interactivity

###### Engage readers with interactivity

-   [Overview](../../docs/interactive/index.html)
-   [Observable JS](../../docs/interactive/ojs/index.html)
-   [Shiny](../../docs/interactive/shiny/index.html)
-   [Widgets](../../docs/interactive/widgets/jupyter.html)
...
-   [Publishing Basics](../../docs/publishing/index.html)
...
-   [Confluence](../../docs/publishing/confluence.html)
-   [Other Services](../../docs/publishing/other.html)

#### Projects

###### Scale up your work with projects

-   [Project Basics](../../docs/projects/quarto-projects.html)
-   [Managing Execution](../../docs/projects/code-execution.html)
-   [Project Profiles](../../docs/projects/profiles.html)
-   [Environment Variables](../../docs/projects/environment.html)
-   [Project Scripts](../../docs/projects/scripts.html)
-   [Virtual
    Environments](../../docs/projects/virtual-environments.html)

#### Advanced

###### Refine documents with advanced tools

-   [Includes](../../docs/authoring/includes.html)
-   [Variables](../../docs/authoring/variables.html)
-   [Page Layout](../../docs/output-formats/page-layout.html)
-   [Document Language](../../docs/authoring/language.html)
-   [Conditional Content](../../docs/authoring/conditional.html)
-   [Notebook Filters](../../docs/extensions/nbfilter.html)

No matching items

<a href="../../docs/authoring/markdown-basics.html"
class="pagination-link" aria-label="Markdown Basics"><span
class="nav-page-text">Markdown Basics</span> <em></em></a>
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/guide/index.qmd"
