...
3.  [Markdown](../../../../docs/reference/formats/markdown/gfm.html)
4.  [GitHub](../../../../docs/reference/formats/markdown/gfm.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/markdown/gfm.qmd"
...
GitHub Enterprise. To learn about GFM see
<https://github.github.com/gfm/>.

See the GFM format [user
guide](../../../../docs/output-formats/gfm.html) for more details on
creating GFM output with Quarto.
...
<td style="text-align: left;"><p>Enable and disable extensions for
markdown output (e.g. “+emoji”)</p></td>
</tr>
<tr class="even even">
<td style="text-align: left;"><code>markdown-headings</code></td>
<td style="text-align: left;"><p>Specify whether to use <code>atx</code>
(<code>#</code>-prefixed) or <code>setext</code> (underlined) headings
for level 1 and 2 headings (<code>atx</code> or
<code>setext</code>).</p></td>
</tr>
<tr class="odd odd">
<td style="text-align: left;"><code>keep-yaml</code></td>
<td style="text-align: left;"><p>Preserve the original YAML front matter
in rendered markdown</p></td>
</tr>
<tr class="even even">
...
<a href="../../../../docs/reference/formats/dashboards.html"
class="pagination-link aria-label=" data-dashboards"=""><em></em> <span
class="nav-page-text">Dashboards</span></a>

<a href="../../../../docs/reference/formats/markdown/commonmark.html"
class="pagination-link" aria-label="CommonMark"><span
class="nav-page-text">CommonMark</span> <em></em></a>
