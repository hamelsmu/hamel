...
3.  [Using Observable](../../docs/computations/ojs.html)
...
-   <a href="../../docs/guide/index.html"
    ...
    -   <span class="sidebar-item-text sidebar-link text-start"
        ...
        -   <a href="../../docs/computations/ojs.html"
            ...
            class="menu-text">Using Observable</span></a>
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/computations/ojs.qmd"
...
[Penguins](../../docs/interactive/ojs/examples/penguins.html) examples
...
-   [Libraries](../../docs/interactive/ojs/libraries.html) covers using
    standard libraries and external JavaScript libraries.
...
-   [Shiny Reactives](../../docs/interactive/ojs/shiny.html) describes
    how to integrate Shiny with OJS.

-   [Code Reuse](../../docs/interactive/ojs/code-reuse.html) delves into
    ways to re-use OJS code across multiple documents.
...
data-julia"=""><em></em> <span class="nav-page-text">Using
Julia</span></a>

<a href="../../docs/computations/execution-options.html"
class="pagination-link" aria-label="Execution Options"><span
class="nav-page-text">Execution Options</span> <em></em></a>
