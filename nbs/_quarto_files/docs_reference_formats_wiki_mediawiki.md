...
4.  [MediaWiki](../../../../docs/reference/formats/wiki/mediawiki.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/wiki/mediawiki.qmd"
...
MediaWiki is the native document format of Wikipedia. To learn more
about MediaWiki see <https://www.mediawiki.org>.
...
<a href="../../../../docs/reference/formats/markdown/markua.html"
class="pagination-link aria-label=" data-markua"=""><em></em> <span
class="nav-page-text">Markua</span></a>

<a href="../../../../docs/reference/formats/wiki/dokuwiki.html"
class="pagination-link" aria-label="DokuWiki"><span
class="nav-page-text">DokuWiki</span> <em></em></a>
