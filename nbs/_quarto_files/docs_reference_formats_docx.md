...
3.  [MS Word](../../../docs/reference/formats/docx.html)
...
-   <a href="../../../docs/reference/index.html"
    ...
    -   <span class="sidebar-item-text sidebar-link text-start"
        ...
        -   <a href="../../../docs/reference/formats/docx.html"
            class="sidebar-item-text sidebar-link active"><span class="menu-text">MS
            Word</span></a>
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/docx.qmd"
...
MS Word is the word processor included with Microsoft Office. Word uses
the OpenXML document format, which you can learn more about at
<https://en.wikipedia.org/wiki/Office_Open_XML>.

See the MS Word format [user
guide](../../../docs/output-formats/ms-word.html) for more details on
creating MS Word output with Quarto.
...
<tbody>
<tr class="odd odd">
<td style="text-align: left;"><code>reference-doc</code></td>
<td style="text-align: left;"><p>Use the specified file as a style
reference in producing a docx, pptx, or odt file.</p></td>
</tr>
<tr class="even even">
...
<tbody>
<tr class="odd odd">
<td style="text-align: left;"><code>page-width</code></td>
<td style="text-align: left;"><p>Target page width for output (used to
compute columns widths for <code>layout</code> divs). Defaults to 6.5
inches, which corresponds to default letter page settings in docx and
odt.</p></td>
</tr>
<tr class="even even">
...
<td style="text-align: left;"><p>The document description. Some
applications show this as <code>Comments</code> metadata.</p></td>
</tr>
<tr class="odd odd">
<td style="text-align: left;"><code>category</code></td>
<td style="text-align: left;"><p>The document category.</p></td>
</tr>
</tbody>
</table>
...
<a href="../../../docs/reference/formats/pdf.html"
class="pagination-link aria-label=" data-pdf"=""><em></em> <span
class="nav-page-text">PDF</span></a>

<a href="../../../docs/reference/formats/odt.html"
class="pagination-link" aria-label="OpenOffice"><span
class="nav-page-text">OpenOffice</span> <em></em></a>
