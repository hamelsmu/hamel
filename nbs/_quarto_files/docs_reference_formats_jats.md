...
4.  [JATS](../../../docs/reference/formats/jats.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/jats.qmd"
...
JATS (Journal Article Tag Suite) is an XML format for marking up and
exchanging journal content. You can learn more about JATS here
...
<tr class="even even">
<td style="text-align: left;"><code>affiliation</code></td>
<td style="text-align: left;"><p>The list of organizations with which
contributors are affiliated. Each institution is added as an
[<code>&lt;aff&gt;</code>] element to the author’s contrib-group. See
the Pandoc <a href="https://pandoc.org/jats.html">JATS documentation</a>
for details on <code>affiliation</code> fields.</p></td>
</tr>
<tr class="odd odd">
<td style="text-align: left;"><code>copyright</code></td>
<td style="text-align: left;"><p>Licensing and copyright information.
This information is rendered via the <a
href="https://jats.nlm.nih.gov/publishing/tag-library/1.2/element/permissions.html"><code>&lt;permissions&gt;</code></a>
element. The variables <code>type</code>, <code>link</code>, and
<code>text</code> should always be used together. See the Pandoc <a
href="https://pandoc.org/jats.html">JATS documentation</a> for details
on <code>copyright</code> fields.</p></td>
</tr>
<tr class="even even">
<td style="text-align: left;"><code>article</code></td>
<td style="text-align: left;"><p>Information concerning the article that
identifies or describes it. The key-value pairs within this map are
typically used within the <a
href="https://jats.nlm.nih.gov/publishing/tag-library/1.2/element/article-meta.html"><code>&lt;article-meta&gt;</code></a>
element. See the Pandoc <a href="https://pandoc.org/jats.html">JATS
documentation</a> for details on <code>article</code> fields.</p></td>
</tr>
<tr class="odd odd">
<td style="text-align: left;"><code>journal</code></td>
<td style="text-align: left;"><p>Information on the journal in which the
article is published. See the Pandoc <a
href="https://pandoc.org/jats.html">JATS documentation</a> for details
on <code>journal</code> fields.</p></td>
</tr>
<tr class="even even">
...
<td style="text-align: left;"><p>Additional notes concerning the whole
article. Added to the article’s frontmatter via the <a
href="https://jats.nlm.nih.gov/publishing/tag-library/1.2/element/notes.html"><code>&lt;notes&gt;</code></a>
element.</p></td>
</tr>
<tr class="even even">
<td style="text-align: left;"><code>tags</code></td>
<td style="text-align: left;"><p>List of keywords. Items are used as
contents of the <a
href="https://jats.nlm.nih.gov/publishing/tag-library/1.2/element/kwd.html"><code>&lt;kwd&gt;</code></a>
element; the elements are grouped in a <a
href="https://jats.nlm.nih.gov/publishing/tag-library/1.2/element/kwd-group.html"><code>&lt;kwd-group&gt;</code></a>
with the <a
href="https://jats.nlm.nih.gov/publishing/tag-library/1.2/attribute/kwd-group-type.html"><code>kwd-group-type</code></a>
value <code>author</code>.</p></td>
</tr>
<tr class="odd odd">
...
<tr class="even even">
<td style="text-align: left;"><code>preview-mode</code></td>
<td style="text-align: left;"><p>The mode to use when previewing this
document. To disable any special previewing features, pass
<code>raw</code> as the preview-mode.</p></td>
</tr>
</tbody>
</table>
...
source, there will be nonsemantic newlines in the output as well.</li>
</ul></td>
</tr>
<tr class="even even">
...
<a href="../../../docs/reference/formats/wiki/xwiki.html"
class="pagination-link aria-label=" data-xwiki"=""><em></em> <span
class="nav-page-text">XWiki</span></a>

<a href="../../../docs/reference/formats/ipynb.html"
class="pagination-link" aria-label="Jupyter"><span
class="nav-page-text">Jupyter</span> <em></em></a>
