...
4.  [Jupyter](../../../docs/reference/formats/ipynb.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/ipynb.qmd"
...
Jupyter Notebooks are used to combine software code, computational
output, explanatory text and multimedia resources in a single document.
Learn more about the Jupyter Notebook format at
...
<tr class="even even">
<td style="text-align: left;"><code>ipynb-output</code></td>
<td style="text-align: left;"><p>Determines which ipynb cell output
formats are rendered.</p>
<ul>
<li><code>all</code>: Preserve all of the data formats included in the
original.</li>
<li><code>none</code>: Omit the contents of data cells.</li>
<li><code>best</code> (default): Instruct pandoc to try to pick the
...
<a href="../../../docs/reference/formats/jats.html"
class="pagination-link aria-label=" data-jats"=""><em></em> <span
class="nav-page-text">JATS</span></a>

<a href="../../../docs/reference/formats/context.html"
class="pagination-link" aria-label="ConTeXt"><span
class="nav-page-text">ConTeXt</span> <em></em></a>
