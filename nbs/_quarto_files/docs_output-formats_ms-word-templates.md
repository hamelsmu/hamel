...
2.  Documents
3.  [MS Word](../../docs/output-formats/ms-word.html)
4.  [Word Templates](../../docs/output-formats/ms-word-templates.html)
...
-   <a href="../../docs/guide/index.html"
    ...
    -   <span class="sidebar-item-text sidebar-link text-start"
        ...
        -   <span class="sidebar-item-text sidebar-link text-start"
            ...
            aria-expanded="true"><span class="menu-text">MS
            Word</span></span> <span
            class="sidebar-item-toggle text-start" bs-toggle="collapse"
            bs-target="#quarto-sidebar-section-13" aria-expanded="true"
            aria-label="Toggle section"></span>
            ...
            -   <a href="../../docs/output-formats/ms-word-templates.html"
                ...
                class="menu-text">Word Templates</span></a>
...
-   <a href="#using-templates" id="toc-using-templates"
    class="nav-link active" data-scroll-target="#using-templates">Using
    Templates</a>
-   <a href="#creating-templates" id="toc-creating-templates"
    class="nav-link" data-scroll-target="#creating-templates">Creating
    Templates</a>

-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/output-formats/ms-word-templates.qmd"
...
If you want to customize the appearance of MS Word output, Pandoc
supports a special type of template called a *reference document*.
Here’s an example of specifying a custom reference document for `docx`:

    format:
      docx:
        reference-doc: custom-reference-doc.docx

Reference documents include sample text that uses all of the output
styles used by Pandoc.

To use a reference doc template, just copy it to your document’s
directory and reference it as shown above.
...
Then, open `custom-reference-doc.docx` in MS Word and modify styles as
you wish:

<figure>
<img src="images/word-styles.png"
class="preview-image img-fluid figure-img"
...
alt="Modify Style dialog box with a properties section for selecting what is to be styled, and a formatting section for selecting the style settings. The color selection dropdown in the formatting section is open." />
...
data-basics"=""><em></em> <span class="nav-page-text">Word
Basics</span></a>

<a href="../../docs/output-formats/gfm.html" class="pagination-link"
aria-label="GitHub (GFM)"><span class="nav-page-text">GitHub
(GFM)</span> <em></em></a>
