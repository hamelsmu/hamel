...
3.  [Citations](../../../docs/reference/metadata/citation.html)
...
-   <a href="#citation" id="toc-citation" class="nav-link active"
    data-scroll-target="#citation">Citation</a>

-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/metadata/citation.qmd"
...
You can provide citation data for Quarto documents in the document front
matter. The citation options are based upon the [Citation Style Language
(CSL) specification for
items](https://docs.citationstyles.org/en/stable/specification.html),
but as YAML (rather than XML).
...
<td style="text-align: left;"><p>Abstract of the item (e.g. the abstract
of a journal article)</p></td>
</tr>
<tr class="even even">
<td style="text-align: left;"><code>author</code></td>
<td style="text-align: left;"><p>The author(s) of the item.</p></td>
</tr>
<tr class="odd odd">
<td style="text-align: left;"><code>doi</code></td>
<td style="text-align: left;"><p>Digital Object Identifier
(e.g. “10.1128/AEM.02591-07”)</p></td>
</tr>
<tr class="even even">
<td style="text-align: left;"><code>references</code></td>
<td style="text-align: left;"><p>Resources related to the procedural
history of a legal case or legislation;</p>
<p>Can also be used to refer to the procedural history of other items
...
<td style="text-align: left;"><p>The primary title of the item.</p></td>
</tr>
</tbody>
</table>

<a href="../../../docs/reference/globs.html"
class="pagination-link aria-label=" data-globs"=""><em></em> <span
class="nav-page-text">Globs</span></a>
