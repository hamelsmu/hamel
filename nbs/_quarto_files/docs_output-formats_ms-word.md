...
4.  [Word Basics](../../docs/output-formats/ms-word.html)
    ...
    -   <span class="sidebar-item-text sidebar-link text-start"
        ...
        -   <span class="sidebar-item-text sidebar-link text-start"
            ...
            -   <a href="../../docs/output-formats/ms-word.html"
                ...
                class="menu-text">Word Basics</span></a>
...
-   <a href="#syntax-highlighting" id="toc-syntax-highlighting"
    class="nav-link" data-scroll-target="#syntax-highlighting">Syntax
    Highlighting</a>
-   <a href="#code-annotation" id="toc-code-annotation" class="nav-link"
    data-scroll-target="#code-annotation">Code Annotation</a>

-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/output-formats/ms-word.qmd"
...
This example highlights a few of the options available for MS Word
output. This document covers these and other options in detail. See the
Word [format reference](../../docs/reference/formats/docx.html) for a
complete list of all available options.

To learn about creating custom templates for use with the `docx` format,
see the article on [Word
Templates](../../docs/output-formats/ms-word-templates.html).
...
If you want to exclude a heading from the table of contents, add both
...
specifying one of the supported themes. Supported themes include: arrow,
pygments, tango, espresso, zenburn, kate, monochrome, breezedark,
haddock, atom-one, ayu, breeze, dracula, github, gruvbox, monokai, nord,
oblivion, printing, radical, solarized, and vim.
...
chunk background color’s darkness. You may always opt to specify the
...
data-engines"=""><em></em> <span class="nav-page-text">PDF
Engines</span></a>

<a href="../../docs/output-formats/ms-word-templates.html"
class="pagination-link" aria-label="Word Templates"><span
class="nav-page-text">Word Templates</span> <em></em></a>
