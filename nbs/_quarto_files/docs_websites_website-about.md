...
3.  [About Pages](../../docs/websites/website-about.html)
...
-   <a href="../../docs/guide/index.html"
    ...
    -   <a href="../../docs/websites/index.html"
        ...
        -   <a href="../../docs/websites/website-about.html"
            ...
            class="menu-text">About Pages</span></a>
...
-   <a href="#templates" id="toc-templates" class="nav-link"
    ...
    -   <a href="#image" id="toc-image" class="nav-link"
        data-scroll-target="#image">Image</a>
    -   <a href="#links" id="toc-links" class="nav-link"
        data-scroll-target="#links">Links</a>
-   <a href="#partial-page-content" id="toc-partial-page-content"
    class="nav-link" data-scroll-target="#partial-page-content">Partial Page
    Content</a>

-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/websites/website-about.qmd"
...
Quarto makes it easy to create a simple about page for an individual or
organization. When the `about` option is provided for a document, a
special template will be used to layout the content of the current page
with a custom layout designed to present a person or organization.
...
The contents of this page will be laid out using the `jolla` template
with the `profile.jpg` image, and generate a set of links for the items
specified in `links`.

You can write and format the content of the page however you’d like -
when the page is rendered, Quarto will use the content and options
provided in the `about` option to create the about page, arranging the
content of the `about` option with the content in the page itself.

## Templates

Quarto includes 5 built in templates, drawing inspiration from the
[Postcards R
Package](https://cran.r-project.org/web/packages/postcards/readme/README.html).
...
Each template will position the about elements with the content in a
different layout. Select the template using the `template` option:
...
-   <span id="tabset-1-1-tab" class="nav-link active" bs-toggle="tab"
    ...
    aria-selected="true">jolla</span>
-   <span id="tabset-1-2-tab" class="nav-link" bs-toggle="tab"
    bs-target="#tabset-1-2" role="tab" aria-controls="tabset-1-2"
    aria-selected="false">trestles</span>
-   <span id="tabset-1-3-tab" class="nav-link" bs-toggle="tab"
    bs-target="#tabset-1-3" role="tab" aria-controls="tabset-1-3"
    aria-selected="false">solana</span>
-   <span id="tabset-1-4-tab" class="nav-link" bs-toggle="tab"
    bs-target="#tabset-1-4" role="tab" aria-controls="tabset-1-4"
    aria-selected="false">marquee</span>
-   <span id="tabset-1-5-tab" class="nav-link" bs-toggle="tab"
    bs-target="#tabset-1-5" role="tab" aria-controls="tabset-1-5"
    aria-selected="false">broadside</span>

<img src="images/about-jolla.png" class="border img-fluid"
alt="Screenshot of About page with jolla template. Photo is a centered circle above a heading with the author&#39;s name. There is a centered paragraph below the header, a separator line, and then buttons for twitter and github centered at the bottom." />

<img src="images/about-trestles.png" class="border img-fluid"
alt="Screenshot of About page with trestles template. On the left-hand side there is a rectangular photo above the author&#39;s name, and two buttons (one for twitter, and one for github below). On the right hand side there is a paragraph of body text followed by headered sections for Education and Experience." />

<img src="images/about-solana.png" class="border img-fluid"
...
<img src="images/about-marquee.png" class="border img-fluid"
...
<img src="images/about-broadside.png" class="border img-fluid"
...
The image for the about page will be read from the document-level
`image` option:
...
In addition, you can customize how the image is displayed in the page to
better meet your needs by setting the following options.
...
<td>A valid CSS width for your image.</td>
<td>all</td>
</tr>
<tr class="even even">
<td><code>image-shape</code></td>
<td>The shape of the image on the about page. Choose
from:<code>rectangle</code>, <code>round</code>,
<code>rounded</code></td>
<td><code>jolla</code>, <code>solana</code>, <code>trestles</code></td>
</tr>
<tr class="odd odd">
<td><code>image-alt</code></td>
<td>Alternative text for image</td>
<td>all</td>
</tr>
<tr class="even even">
...
Your about page also may contain a set of links to other resources about
you or your organization. Each template will render these links in a
slightly different way. Here are the options that you can specify for
each link:
...
<td>Link to file contained with the project or an external URL.</td>
</tr>
<tr class="even even">
<td><code>text</code></td>
<td>Text to display for navigation item (defaults to the
document <code>title</code> if not provided).</td>
</tr>
<tr class="odd odd">
<td><code>icon</code></td>
<td>Name of one of the standard <a
href="https://icons.getbootstrap.com/">Bootstrap 5
icons</a> (e.g. “github”, “twitter”, “share”, etc.).</td>
</tr>
<tr class="even even">
...
By default, the about page will be generated using the entire contents
of the page. If you’d like, however, you may also choose to use only a
portion of the page’s content to populate the about template. In this
case, you can specify an `id` for the about page in the document front
matter. When rendering the page, Quarto will find any `div` with that
`id` and use the contents of that `div` to populate the about template.
The `div` that provided the contents will be replaced with the formatted
‘about’ content. For example, you could write:
...
data-tools"=""><em></em> <span class="nav-page-text">Website
Tools</span></a>

<a href="../../docs/websites/website-listings.html"
class="pagination-link" aria-label="Listing Pages"><span
class="nav-page-text">Listing Pages</span> <em></em></a>
