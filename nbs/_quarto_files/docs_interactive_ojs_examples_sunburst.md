...
5.  [Sunburst](../../../../docs/interactive/ojs/examples/sunburst.html)
...
diagram](https://observablehq.com/@d3/sunburst) shows only two layers of
the hierarchy at a time. Click a node to zoom in, or the center to zoom
out. Compare to an
...
<a href="../../../../docs/interactive/ojs/examples/penguins.html"
class="pagination-link aria-label=" data-penguins"=""><em></em> <span
class="nav-page-text">Penguins</span></a>

<a href="../../../../docs/interactive/ojs/examples/arquero.html"
class="pagination-link" aria-label="Arquero"><span
class="nav-page-text">Arquero</span> <em></em></a>
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/interactive/ojs/examples/sunburst.qmd"
