    ...
    -   <span class="sidebar-item-text sidebar-link text-start"
        ...
        -   <span class="sidebar-item-text sidebar-link text-start"
            ...
            -   <a href="../../docs/output-formats/html-multi-format.html"
                ...
                class="menu-text">Including Other Formats</span></a>
...
-   <a href="#rendering-formats-with-the-same-extension"
    id="toc-rendering-formats-with-the-same-extension" class="nav-link"
    data-scroll-target="#rendering-formats-with-the-same-extension">Rendering
    Formats with the Same Extension</a>
-   <a href="#specifying-formats-to-link"
    id="toc-specifying-formats-to-link" class="nav-link"
    data-scroll-target="#specifying-formats-to-link">Specifying Formats to
    Link</a>
-   <a href="#hiding-all-links" id="toc-hiding-all-links" class="nav-link"
    data-scroll-target="#hiding-all-links">Hiding All Links</a>
-   <a href="#controlling-formats-at-a-project-level"
    id="toc-controlling-formats-at-a-project-level" class="nav-link"
    data-scroll-target="#controlling-formats-at-a-project-level">Controlling
    Formats at a Project Level</a>

-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/output-formats/html-multi-format.qmd"
...
-   <a href="html-multi-format.ipynb"
    download="html-multi-format.ipynb"><em></em>Jupyter</a>
-   [MS Word](html-multi-format.docx)
...
<img src="images/other-format.png" class="border img-fluid"
...
The Render buttons in RStudio and VS Code will not automatically render
all formats if the document isn’t part of a Quarto website. To render
all formats use `quarto render` on the command line:
...
[Directory
Metadata](../../docs/projects/quarto-projects.html#directory-metadata)
or [Project
Metadata](../../docs/projects/quarto-projects.html#project-metadata) for
additional details.

The `format` option isn’t merged like all other
[metadata](https://quarto.org/docs/projects/quarto-projects.html#metadata-merging)
...
data-theming"=""><em></em> <span class="nav-page-text">HTML
Theming</span></a>

<a href="../../docs/output-formats/html-publishing.html"
class="pagination-link" aria-label="Publishing HTML"><span
class="nav-page-text">Publishing HTML</span> <em></em></a>
