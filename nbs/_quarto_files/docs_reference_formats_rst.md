...
4.  [reST](../../../docs/reference/formats/rst.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/rst.qmd"
...
simple web pages, and for standalone documents. You can learn more about
reStructuredText at <https://docutils.sourceforge.io/rst.html>.
...
<tbody>
<tr class="odd odd">
<td style="text-align: left;"><code>list-tables</code></td>
<td style="text-align: left;"><p>If true, tables are formatted as RST
list tables.</p></td>
</tr>
</tbody>
</table>
...
<a href="../../../docs/reference/formats/rtf.html"
class="pagination-link aria-label=" data-rtf"=""><em></em> <span
class="nav-page-text">RTF</span></a>

<a href="../../../docs/reference/formats/asciidoc.html"
class="pagination-link" aria-label="AsciiDoc"><span
class="nav-page-text">AsciiDoc</span> <em></em></a>
