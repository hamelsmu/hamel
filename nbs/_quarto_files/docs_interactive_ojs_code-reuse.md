...
4.  [Code Reuse](../../../docs/interactive/ojs/code-reuse.html)
    ...
    -   <span class="sidebar-item-text sidebar-link text-start"
        ...
        -   <a href="../../../docs/interactive/ojs/index.html"
            ...
            -   <a href="../../../docs/interactive/ojs/code-reuse.html"
                ...
                class="menu-text">Code Reuse</span></a>
...
-   <a href="#modules" id="toc-modules" class="nav-link active"
    data-scroll-target="#modules">Modules</a>
-   <a href="#data" id="toc-data" class="nav-link"
    data-scroll-target="#data">Data</a>
-   <a href="#output" id="toc-output" class="nav-link"
    data-scroll-target="#output">Output</a>

-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/interactive/ojs/code-reuse.qmd"
...
As you build larger Quarto projects (like [websites](../../websites/)
and [books](../../books/)) that incorporate OJS, you’ll likely want to
re-use code, data, and output across different pages.

## Modules

JavaScript modules are directly supported in Quarto’s OJS blocks. For
example, if we have the following source file `square.js`:
...
You may be using Python or R to pre-process data that is then provided
to OJS via the `ojs_define()` function (this is described in more depth
in the [Data Sources](data-sources.html#python-and-r) article). If you
want to share data prepared in this fashion you can import it directly
from another `.qmd`.

For example, here we import the `co2data` that we read and pre-processed
with dplyr in
[`data-sources.qmd`](../../../docs/interactive/ojs/data-sources.html):
...
You can import any reactive value from another `.qmd` file. Here, we’re
reusing a chart directly from
[`data-sources.qmd`](../../../docs/interactive/ojs/data-sources.html):
...
<a href="../../../docs/interactive/ojs/shiny.html"
class="pagination-link aria-label=" data-shiny=""
data-reactives"=""><em></em> <span class="nav-page-text">Shiny
Reactives</span></a>

<a href="../../../docs/interactive/ojs/examples/penguins.html"
class="pagination-link" aria-label="Penguins"><span
class="nav-page-text">Penguins</span> <em></em></a>
