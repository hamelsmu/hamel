...
3.  [Options](../../../docs/reference/projects/options.html)
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/projects/options.qmd"
...
<a href="../../../docs/reference/cells/cells-ojs.html"
class="pagination-link aria-label=" data-observable"=""><em></em> <span
class="nav-page-text">Observable</span></a>

<a href="../../../docs/reference/projects/websites.html"
class="pagination-link" aria-label="Websites"><span
class="nav-page-text">Websites</span> <em></em></a>
