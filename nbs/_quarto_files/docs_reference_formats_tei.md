...
4.  [TEI Simple](../../../docs/reference/formats/tei.html)
    ...
    -   <span class="sidebar-item-text sidebar-link text-start"
        ...
        -   <span class="sidebar-item-text sidebar-link text-start"
            ...
            -   <a href="../../../docs/reference/formats/tei.html"
                ...
                class="menu-text">TEI Simple</span></a>
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/reference/formats/tei.qmd"
...
TEI Simple aims to define a new *highly-constrained* and *prescriptive*
subset of the Text Encoding Initiative (TEI) Guidelines suited to the
representation of early modern and modern books, a formally-defined set
of processing rules which permit modern web applications to easily
present and analyze the encoded texts, mapping to other ontologies, and
processes to describe the encoding status and richness of a TEI digital
text. Learn more about TEI at <https://github.com/TEIC/TEI-Simple>.
...
<a href="../../../docs/reference/formats/icml.html"
class="pagination-link aria-label=" data-indesign"=""><em></em> <span
class="nav-page-text">InDesign</span></a>

<a href="../../../docs/reference/formats/fb2.html"
class="pagination-link" aria-label="FictionBook"><span
class="nav-page-text">FictionBook</span> <em></em></a>
