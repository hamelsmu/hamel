...
5.  [Arquero](../../../../docs/interactive/ojs/examples/arquero.html)
...
Simple demonstration of [Arquero](https://uwdata.github.io/arquero/)
using Allison Horst’s [Palmer
...
If you want to use inputs in an arquero query, you can use the `params`
method of table. Below is a simple example of filtering a dataset by the
values provided.
...
<a href="../../../../docs/interactive/ojs/examples/sunburst.html"
class="pagination-link aria-label=" data-sunburst"=""><em></em> <span
class="nav-page-text">Sunburst</span></a>

<a href="../../../../docs/interactive/ojs/examples/population.html"
class="pagination-link" aria-label="Population"><span
class="nav-page-text">Population</span> <em></em></a>
...
-   <a
    href="https://github.com/quarto-dev/quarto-web/edit/main/docs/interactive/ojs/examples/arquero.qmd"
